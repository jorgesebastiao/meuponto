...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
    ...
    public RefreshTokenPostProcessor(MeuPontoSecutiryProperty meuPontoSecutiryProperty) {
    ...
    private void addRefreshTokenNoCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
        ...
        refreshTokenCookie.setSecure(meuPontoSecutiryProperty.getSecurity().isEnableHttps());
        refreshTokenCookie.setPath(req.getContextPath() + meuPontoSecutiryProperty.getSecurity().getOauthPath());
